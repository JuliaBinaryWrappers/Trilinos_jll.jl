# Autogenerated wrapper script for Trilinos_jll for armv7l-linux-musleabihf-libgfortran5-cxx11-mpi+openmpi
...
function __init__()
    JLLWrappers.@generate_init_header(SuiteSparse_jll, libblastrampoline_jll, Kokkos_jll, NetCDF_jll, CompilerSupportLibraries_jll, Matio_jll, OpenMPI_jll, MPIPreferences)
